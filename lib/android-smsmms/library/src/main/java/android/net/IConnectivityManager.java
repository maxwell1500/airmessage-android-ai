...
public interface IConnectivityManager extends android.os.IInterface {
     ...
     */
    abstract class Stub extends android.os.Binder implements android.net.IConnectivityManager {
    ...
    void setNetworkPreference(int pref) throws android.os.RemoteException;

    int getNetworkPreference() throws android.os.RemoteException;

    android.net.NetworkInfo getActiveNetworkInfo() throws android.os.RemoteException;

    android.net.NetworkInfo getActiveNetworkInfoForUid(int uid) throws android.os.RemoteException;

    android.net.NetworkInfo getNetworkInfo(int networkType) throws android.os.RemoteException;

    android.net.NetworkInfo[] getAllNetworkInfo() throws android.os.RemoteException;

    boolean isNetworkSupported(int networkType) throws android.os.RemoteException;

    android.net.LinkProperties getActiveLinkProperties() throws android.os.RemoteException;

    android.net.LinkProperties getLinkProperties(int networkType) throws android.os.RemoteException;

    android.net.NetworkState[] getAllNetworkState() throws android.os.RemoteException;

    android.net.NetworkQuotaInfo getActiveNetworkQuotaInfo() throws android.os.RemoteException;

    boolean isActiveNetworkMetered() throws android.os.RemoteException;

    boolean setRadios(boolean onOff) throws android.os.RemoteException;

    boolean setRadio(int networkType, boolean turnOn) throws android.os.RemoteException;

    int startUsingNetworkFeature(int networkType, java.lang.String feature, android.os.IBinder binder) throws android.os.RemoteException;

    int stopUsingNetworkFeature(int networkType, java.lang.String feature) throws android.os.RemoteException;

    boolean requestRouteToHost(int networkType, int hostAddress) throws android.os.RemoteException;

    boolean requestRouteToHostAddress(int networkType, byte[] hostAddress) throws android.os.RemoteException;

    boolean getMobileDataEnabled() throws android.os.RemoteException;

    void setMobileDataEnabled(boolean enabled) throws android.os.RemoteException;

    /**
     * Policy control over specific {@link NetworkStateTracker}.
     */
    void setPolicyDataEnable(int networkType, boolean enabled) throws android.os.RemoteException;

    int tether(java.lang.String iface) throws android.os.RemoteException;

    int untether(java.lang.String iface) throws android.os.RemoteException;

    int getLastTetherError(java.lang.String iface) throws android.os.RemoteException;

    boolean isTetheringSupported() throws android.os.RemoteException;

    java.lang.String[] getTetherableIfaces() throws android.os.RemoteException;

    java.lang.String[] getTetheredIfaces() throws android.os.RemoteException;

    /**
     * Return list of interface pairs that are actively tethered.  Even indexes are
     * remote interface, and odd indexes are corresponding local interfaces.
     */
    java.lang.String[] getTetheredIfacePairs() throws android.os.RemoteException;

    java.lang.String[] getTetheringErroredIfaces() throws android.os.RemoteException;

    java.lang.String[] getTetherableUsbRegexs() throws android.os.RemoteException;

    java.lang.String[] getTetherableWifiRegexs() throws android.os.RemoteException;

    java.lang.String[] getTetherableBluetoothRegexs() throws android.os.RemoteException;

    int setUsbTethering(boolean enable) throws android.os.RemoteException;

    void requestNetworkTransitionWakelock(java.lang.String forWhom) throws android.os.RemoteException;

    void reportInetCondition(int networkType, int percentage) throws android.os.RemoteException;

    android.net.ProxyProperties getGlobalProxy() throws android.os.RemoteException;

    void setGlobalProxy(android.net.ProxyProperties p) throws android.os.RemoteException;

    android.net.ProxyProperties getProxy() throws android.os.RemoteException;

    void setDataDependency(int networkType, boolean met) throws android.os.RemoteException;

    boolean protectVpn(android.os.ParcelFileDescriptor socket) throws android.os.RemoteException;

    boolean prepareVpn(java.lang.String oldPackage, java.lang.String newPackage) throws android.os.RemoteException;

    android.os.ParcelFileDescriptor establishVpn(com.android.internal.net.VpnConfig config) throws android.os.RemoteException;

    void startLegacyVpn(com.android.internal.net.VpnProfile profile) throws android.os.RemoteException;

    com.android.internal.net.LegacyVpnInfo getLegacyVpnInfo() throws android.os.RemoteException;

    boolean updateLockdownVpn() throws android.os.RemoteException;

    void captivePortalCheckComplete(android.net.NetworkInfo info) throws android.os.RemoteException;
}

...
public interface INetworkPolicyManager extends android.os.IInterface {
     ...
     */
    abstract class Stub extends android.os.Binder implements android.net.INetworkPolicyManager {
     ...
     * Control UID policies.
     */
    void setUidPolicy(int uid, int policy) throws android.os.RemoteException;

    int getUidPolicy(int uid) throws android.os.RemoteException;

    int[] getUidsWithPolicy(int policy) throws android.os.RemoteException;

    boolean isUidForeground(int uid) throws android.os.RemoteException;

    void registerListener(android.net.INetworkPolicyListener listener) throws android.os.RemoteException;

    void unregisterListener(android.net.INetworkPolicyListener listener) throws android.os.RemoteException;

    /**
     * Control network policies atomically.
     */
    void setNetworkPolicies(android.net.NetworkPolicy[] policies) throws android.os.RemoteException;

    android.net.NetworkPolicy[] getNetworkPolicies() throws android.os.RemoteException;

    /**
     * Snooze limit on policy matching given template.
     */
    void snoozeLimit(android.net.NetworkTemplate template) throws android.os.RemoteException;

    /**
     * Control if background data is restricted system-wide.
     */
    void setRestrictBackground(boolean restrictBackground) throws android.os.RemoteException;

    boolean getRestrictBackground() throws android.os.RemoteException;

    android.net.NetworkQuotaInfo getNetworkQuotaInfo(android.net.NetworkState state) throws android.os.RemoteException;

    boolean isNetworkMetered(android.net.NetworkState state) throws android.os.RemoteException;
}

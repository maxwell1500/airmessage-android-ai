...
class FragmentMessagingAttachmentsViewModelMaps(private val viewModel: FragmentMessagingAttachments.FragmentViewModel) {
    ...
    // Use reflection or cast to access the getApplication method
    @Suppress("UNCHECKED_CAST")
    private val application: Application 
        get() = (viewModel as androidx.lifecycle.AndroidViewModel).getApplication()
    ...
    fun loadLocation() {
        ...
        val locationProvider: FusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(application)

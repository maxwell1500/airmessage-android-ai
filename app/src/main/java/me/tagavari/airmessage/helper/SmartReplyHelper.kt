...
object SmartReplyHelper {
	...
	/**
	 * Fallback to classic approach when Gemini is not available or fails
	 */
	@CheckReturnValue
	private fun fallbackToClassicApproach(context: Context, sortedMessages: List<MessageInfo>): Single<List<AMConversationAction>> {

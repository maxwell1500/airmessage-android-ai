...
public class AppleEffectView extends View {
	...
	private class BalloonRenderer extends EffectRenderer {
		...
		private class Balloon {
			...
			private final float sVerticalSpeed;
			private final float sBalloonHeadWidth;
			private final float sBalloonHeadHeight;
			private final float sBalloonTieSize;
			private final float sBalloonStringLength;

...
public class BlockedAddresses extends AppCompatActivity {
	...
	private class ListAdapter extends ArrayAdapter<BlockedAddress> {
		ListAdapter(Context context, int resource, ArrayList<BlockedAddress> items) {
			...
			//Setting the data
			//filteredData = (ArrayList<ConversationInfo>) items.clone();
		}
	...
	public static class RetainedFragment extends Fragment {
		...
		private final ArrayList<BlockedAddress> originalBlockedList = new ArrayList<>();
		private final ArrayList<BlockedAddress> blockedList = new ArrayList<>();
